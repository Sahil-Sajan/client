...
const Footer = () => {
  return (
    <footer className="w-full bg-[radial-gradient(circle,#3b82f6_0%,#1d4ed8_100%)] text-white pt-16">
      <div className="max-w-7xl mx-auto px-6 flex flex-col items-center">
        ...
        <div className="max-w-2xl text-center mb-10">
          <p className="text-sm md:text-base leading-relaxed text-white/70 font-light italic">
      ...
      <div className="w-full bg-black/20 py-6 border-t border-white/5">
